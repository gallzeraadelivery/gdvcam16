...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    :cond_0
    sget-object p1, LM0/m;->b:[I

    const-string p2, "Theme.MaterialComponents"

    invoke-static {p0, p1, p2}, LM0/m;->c(Landroid/content/Context;[ILjava/lang/String;)V

    :cond_1
    sget-object p1, LM0/m;->a:[I
...
.method public static c(Landroid/content/Context;[ILjava/lang/String;)V
    ...
    invoke-static {p1, p2, v0}, LD/f;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static d(Landroid/view/View;LM0/p;)V
    .locals 5
    ...
    iput v1, v0, LM0/q;->a:I

    iput v2, v0, LM0/q;->b:I

    iput v3, v0, LM0/q;->c:I

    iput v4, v0, LM0/q;->d:I

    new-instance v1, LC/j;

    const/4 v2, 0x3

    invoke-direct {v1, p1, v2, v0}, LC/j;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {p0, v1}, LL/G;->u(Landroid/view/View;LL/r;)V
...
.method public static varargs g(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {p0, p1, p3, p4}, LM0/m;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    invoke-static/range {p0 .. p5}, LM0/m;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
...
.method public static varargs h(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)LL/l;
    .locals 0
    ...
    new-instance p5, LL/l;

    invoke-virtual {p0, p1, p2, p3, p4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    invoke-direct {p5, p0, p1}, LL/l;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
