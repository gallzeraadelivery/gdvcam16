...
.method public final a(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object p0, p0, Lj/g;->E:Lj/h;

    iget-object p0, p0, Lj/h;->c:Landroid/content/Context;
...
.method public final b(Landroid/view/MenuItem;)V
    ...
    invoke-static {v0, v5, v1}, LD/f;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v0, v3}, Lk/o;->f(Z)V
    ...
    invoke-interface {v1, v0}, LF/a;->b(Lk/p;)LF/a;
    ...
    invoke-interface {v2, v0}, LF/a;->setContentDescription(Ljava/lang/CharSequence;)LF/a;

    goto :goto_7

    :cond_d
    invoke-static {p1, v0}, LL/m;->h(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, LF/a;->setTooltipText(Ljava/lang/CharSequence;)LF/a;

    goto :goto_8

    :cond_e
    invoke-static {p1, v0}, LL/m;->m(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, LF/a;->setAlphabeticShortcut(CI)Landroid/view/MenuItem;

    goto :goto_9

    :cond_f
    invoke-static {p1, v0, v2}, LL/m;->g(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, LF/a;->setNumericShortcut(CI)Landroid/view/MenuItem;

    goto :goto_a

    :cond_10
    invoke-static {p1, v0, v2}, LL/m;->k(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, LF/a;->setIconTintMode(Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;

    goto :goto_b

    :cond_11
    invoke-static {p1, v0}, LL/m;->j(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;

    :cond_12
    :goto_b
    iget-object p0, p0, Lj/g;->C:Landroid/content/res/ColorStateList;
    ...
    invoke-interface {p1, p0}, LF/a;->setIconTintList(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;

    goto :goto_c

    :cond_13
    invoke-static {p1, p0}, LL/m;->i(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
