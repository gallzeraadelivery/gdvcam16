...
.method public constructor <init>()V
    ...
    invoke-direct {v2, p0}, LD0/j;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;)V

    iput-object v2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->A:LD0/j;
    ...
    invoke-direct {v0, p0, v1}, LD0/e;-><init>(Ly/a;I)V

    iput-object v0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->d0:LD0/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v4, p0}, LD0/j;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;)V

    iput-object v4, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->A:LD0/j;
    ...
    invoke-direct {v7, p0, v2}, LD0/e;-><init>(Ly/a;I)V

    iput-object v7, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->d0:LD0/e;
    ...
    .line 34
    invoke-static {p1, v7, v8}, LZ0/i;->x(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 36
    invoke-static {p1, p2, v9, v10}, LT0/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)LT0/j;

    move-result-object p2

    .line 37
    invoke-virtual {p2}, LT0/j;->a()LT0/k;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->y:LT0/k;

    .line 38
    :cond_1
    iget-object p2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->y:LT0/k;
    ...
    invoke-direct {v9, p2}, LT0/g;-><init>(LT0/k;)V

    iput-object v9, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:LT0/g;

    .line 40
    invoke-virtual {v9, p1}, LT0/g;->h(Landroid/content/Context;)V
    ...
    .line 42
    iget-object v9, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:LT0/g;

    invoke-virtual {v9, p2}, LT0/g;->j(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v9, p2}, LT0/g;->setTint(I)V
    ...
    invoke-direct {v10, v2, p0}, LD0/c;-><init>(ILjava/lang/Object;)V
...
.method public static v(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p0}, LL/G;->p(Landroid/view/View;)Z
...
.method public final B(I)V
    ...
    invoke-direct {v1, p0, p1, v0}, LD0/b;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;Landroid/view/View;I)V
...
.method public final E(Landroid/view/View;IZ)V
    ...
    iget-object p0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->A:LD0/j;

    invoke-virtual {p0, p2}, LD0/j;->a(I)V
...
.method public final F()V
    ...
    invoke-static {v0, v1}, LL/S;->f(Landroid/view/View;I)V

    const/4 v1, 0x0

    invoke-static {v0, v1}, LL/S;->d(Landroid/view/View;I)V

    const/high16 v2, 0x40000

    invoke-static {v0, v2}, LL/S;->f(Landroid/view/View;I)V
    ...
    invoke-static {v0, v4}, LL/S;->f(Landroid/view/View;I)V
    ...
    invoke-direct {v11, p0, v5}, LD0/f;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0}, LL/S;->b(Landroid/view/View;)Ljava/util/ArrayList;
    ...
    iget-object v7, v7, LM/f;->a:Ljava/lang/Object;
    ...
    invoke-direct/range {v7 .. v12}, LM/f;-><init>(Ljava/lang/Object;ILjava/lang/String;LM/t;Ljava/lang/Class;)V

    invoke-static {v0}, LL/M;->a(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    :cond_8
    instance-of v4, v3, LL/a;

    if-eqz v4, :cond_9

    check-cast v3, LL/a;

    iget-object v3, v3, LL/a;->a:LL/b;
    ...
    invoke-direct {v4, v3}, LL/b;-><init>(Landroid/view/View$AccessibilityDelegate;)V
    ...
    :cond_a
    invoke-static {v0, v3}, LL/S;->h(Landroid/view/View;LL/b;)V

    invoke-virtual {v7}, LM/f;->a()I

    move-result v3

    invoke-static {v0, v3}, LL/S;->f(Landroid/view/View;I)V
    ...
    invoke-direct {v3, p0, v2}, LD0/f;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v3}, LL/S;->g(Landroid/view/View;LM/f;LM/t;)V
    ...
    :cond_e
    sget-object v1, LM/f;->i:LM/f;

    new-instance v4, LD0/f;

    invoke-direct {v4, p0, v2}, LD0/f;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v4}, LL/S;->g(Landroid/view/View;LM/f;LM/t;)V

    sget-object v1, LM/f;->h:LM/f;

    new-instance v2, LD0/f;

    invoke-direct {v2, p0, v3}, LD0/f;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v2}, LL/S;->g(Landroid/view/View;LM/f;LM/t;)V
    ...
    invoke-direct {v2, p0, v5}, LD0/f;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V
...
.method public final G(IZ)V
    ...
    iget-object v2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:LT0/g;
    ...
    :cond_4
    iget-object p2, v2, LT0/g;->a:LT0/f;

    iget p2, p2, LT0/f;->i:F
    ...
    :cond_8
    iget-object p0, v2, LT0/g;->a:LT0/f;

    iget p1, p0, LT0/f;->i:F

    cmpl-float p1, p1, v5

    if-eqz p1, :cond_9

    iput v5, p0, LT0/f;->i:F

    iput-boolean v1, v2, LT0/g;->e:Z

    invoke-virtual {v2}, LT0/g;->invalidateSelf()V
...
.method public final g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:LT0/g;
    ...
    invoke-direct {v6, p0, v2}, LD0/d;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;Z)V

    invoke-static {p2, v6}, LM0/m;->d(Landroid/view/View;LM0/p;)V

    :goto_1
    new-instance v2, LL/d;

    invoke-direct {v2, p2}, LL/d;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v6, v2}, LL/f0;-><init>(LL/d;)V

    invoke-static {p2, v6}, LK0/b;->o(Landroid/view/View;LL/f0;)V

    goto :goto_2

    :cond_3
    sget-object v6, LL/e0;->e:Landroid/view/animation/PathInterpolator;
    ...
    new-instance v7, LL/d0;

    invoke-direct {v7, p2, v2}, LL/d0;-><init>(Landroid/view/View;LL/d;)V
    ...
    invoke-static {v6, v6, v6, v4}, LN/a;->b(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v6

    const v7, 0x7f03035c

    invoke-static {v2, v7, v6}, LZ0/i;->c0(Landroid/content/Context;ILandroid/view/animation/Interpolator;)Landroid/animation/TimeInterpolator;

    const v6, 0x7f03034b

    const/16 v7, 0x12c

    invoke-static {v2, v6, v7}, LZ0/i;->b0(Landroid/content/Context;II)I
    ...
    invoke-static {p2}, LL/G;->i(Landroid/view/View;)F

    move-result v2

    :cond_5
    invoke-virtual {v1, v2}, LT0/g;->i(F)V
    ...
    invoke-static {p2, v1}, LL/G;->q(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v6, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->d0:LD0/e;

    invoke-direct {v1, v2, p1, v6}, LT/e;-><init>(Landroid/content/Context;Landroidx/coordinatorlayout/widget/CoordinatorLayout;LZ0/i;)V
...
.method public final m(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    :cond_7
    iget-boolean p1, p2, LD0/h;->g:Z

    iput-boolean p1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->J:Z

    :cond_8
    :goto_0
    iget p1, p2, LD0/h;->c:I
...
.method public final n(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-direct {p1, p0}, LD0/h;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;)V
...
.method public final s()F
    ...
    iget-object v0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:LT0/g;
    ...
    iget-object v3, v2, LT0/g;->a:LT0/f;

    iget-object v3, v3, LT0/f;->a:LT0/k;

    iget-object v3, v3, LT0/k;->e:LT0/c;

    invoke-virtual {v2}, LT0/g;->f()Landroid/graphics/RectF;

    move-result-object v2

    invoke-interface {v3, v2}, LT0/c;->a(Landroid/graphics/RectF;)F

    move-result v2

    invoke-static {v0}, LD0/a;->h(Landroid/view/WindowInsets;)Landroid/view/RoundedCorner;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-static {v3}, LD0/a;->c(Landroid/view/RoundedCorner;)I
    ...
    invoke-interface {v2, p0}, LT0/c;->a(Landroid/graphics/RectF;)F

    move-result p0

    invoke-static {v0}, LD0/a;->m(Landroid/view/WindowInsets;)Landroid/view/RoundedCorner;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-static {v0}, LD0/a;->c(Landroid/view/RoundedCorner;)I
