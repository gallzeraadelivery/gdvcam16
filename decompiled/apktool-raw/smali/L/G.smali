...
.method public static b(Landroid/view/View;LL/u0;Landroid/graphics/Rect;)LL/u0;
    .locals 1
    ...
    invoke-static {p0, p1}, LL/u0;->f(Landroid/view/View;Landroid/view/WindowInsets;)LL/u0;
...
.method public static j(Landroid/view/View;)LL/u0;
    .locals 6

    sget-boolean v0, LL/j0;->d:Z
    ...
    :try_start_0
    sget-object v1, LL/j0;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v1, LL/j0;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v2, LL/j0;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v3, v4, v5, v1}, LD/c;->b(IIII)LD/c;

    move-result-object v1

    invoke-virtual {v2, v1}, LL/k0;->h(LD/c;)V
    ...
    invoke-static {v1, v3, v4, v0}, LD/c;->b(IIII)LD/c;

    move-result-object v0

    invoke-virtual {v2, v0}, LL/k0;->f(LD/c;)V

    invoke-virtual {v2}, LL/k0;->b()LL/u0;

    move-result-object v0

    iget-object v1, v0, LL/u0;->a:LL/s0;

    invoke-virtual {v1, v0}, LL/s0;->p(LL/u0;)V
...
.method public static u(Landroid/view/View;LL/r;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, LL/F;-><init>(Landroid/view/View;LL/r;)V
