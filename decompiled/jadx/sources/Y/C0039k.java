...
public final class C0039k {
    ...
    public C0039k(ViewGroup viewGroup) {
    ...
    public static final C0039k f(ViewGroup viewGroup, S s2) {
        q1.d.e(viewGroup, "container");
        ...
        C0039k c0039k = new C0039k(viewGroup);
    ...
    public final void a(int i, int i2, Y y2) {
        synchronized (this.f1111b) {
            ...
            d0 d = d(abstractComponentCallbacksC0051x);
            if (d != null) {
                d.c(i, i2);
                return;
            }
            final d0 d0Var = new d0(i, i2, y2, dVar);
            this.f1111b.add(d0Var);
            final int i3 = 0;
            d0Var.d.add(new Runnable(this) { // from class: Y.c0

                /* renamed from: b, reason: collision with root package name */
                public final /* synthetic */ C0039k f1085b;
                ...
                public final void run() {
                    switch (i3) {
                        case 0:
                            C0039k c0039k = this.f1085b;
                            q1.d.e(c0039k, "this$0");
                            d0 d0Var2 = d0Var;
                            if (c0039k.f1111b.contains(d0Var2)) {
                                int i4 = d0Var2.f1089a;
                                View view = d0Var2.f1091c.f1155F;
                            ...
                            break;
                        default:
                            C0039k c0039k2 = this.f1085b;
                            q1.d.e(c0039k2, "this$0");
                            d0 d0Var3 = d0Var;
                            c0039k2.f1111b.remove(d0Var3);
                            c0039k2.f1112c.remove(d0Var3);
                            break;
                    }
                }
            });
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0279, code lost:
        ...
        r20 = r10;
        r1 = r21;
        r6.addListener(new Y.C0037i(r1, r2, r3, r12, r4));
        r6.setTarget(r2);
        r6.start();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:112:0x02b2, code lost:
        ...
        ((H.d) r4.f1102b).a(new Y.C0032d(r6, r12));
        r0 = r23;
        r6 = r17;
        r3 = r1;
        r10 = r20;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:141:0x0335, code lost:
        ...
        r13 = (android.view.animation.Animation) r13.f48b;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:146:0x0376, code lost:
        ...
        ((H.d) r3.f1102b).a(new Y.C0033e(r3, r1, r4, r5));
        r0 = r22;
        r2 = r23;
     */
    /* JADX WARN: Code restructure failed: missing block: B:149:0x0349, code lost:
        ...
        r0.setAnimationListener(new Y.AnimationAnimationListenerC0038j(r3, r1, r4, r5));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00de, code lost:
        ...
        r13 = ((Y.d0) r12.next()).f1091c.f1157I;
        r14 = r5.f1157I;
        r13.f1142b = r14.f1142b;
        r13.f1143c = r14.f1143c;
        r13.d = r14.d;
        r13.f1144e = r14.f1144e;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x0105, code lost:
        ...
        r15 = r5.f1092e;
        r15.add(r14);
        r2.add(new Y.C0034f(r5, r14, r23));
        r13 = new H.d();
        r5.d();
        r15.add(r13);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0195, code lost:
        ...
        if (((Y.C0036h) r5).h() != false) goto L188;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x01d2, code lost:
        ...
        r3 = (Y.C0036h) r0.next();
        r13.put((Y.d0) r3.f1101a, java.lang.Boolean.FALSE);
        r3.d();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:99:0x0226, code lost:
        ...
        r6 = (android.animation.Animator) r6.f49c;
     */
    /*
    ...
    */
    public final void b(java.util.ArrayList r22, boolean r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Y.C0039k.b(java.util.ArrayList, boolean):void");
    }
    ...
    public final void c() {
        ...
        ViewGroup viewGroup = this.f1110a;
        ...
        synchronized (this.f1111b) {
            try {
                if (!this.f1111b.isEmpty()) {
                    ArrayList z02 = j1.j.z0(this.f1112c);
                    this.f1112c.clear();
                    ...
                    while (it.hasNext()) {
                        ...
                        d0Var.a();
                        if (!d0Var.f1094g) {
                            this.f1112c.add(d0Var);
                        }
                    }
                    g();
                    ArrayList z03 = j1.j.z0(this.f1111b);
                    this.f1111b.clear();
                    this.f1112c.addAll(z03);
                    if (S.H(2)) {
    ...
    public final d0 d(AbstractComponentCallbacksC0051x abstractComponentCallbacksC0051x) {
        Object obj;
    ...
    public final void e() {
        ...
        synchronized (this.f1111b) {
            try {
                ...
                Iterator it2 = j1.j.z0(this.f1112c).iterator();
                while (it2.hasNext()) {
                    ...
                    if (S.H(2)) {
                        if (isAttachedToWindow) {
                            ...
                            str2 = "Container " + this.f1110a + " is not attached to window. ";
                        }
                        Log.v("FragmentManager", "SpecialEffectsController: " + str2 + "Cancelling running operation " + d0Var);
                    }
                    d0Var.a();
                }
                Iterator it3 = j1.j.z0(this.f1111b).iterator();
                while (it3.hasNext()) {
                    ...
                    if (S.H(2)) {
                        if (isAttachedToWindow) {
                            ...
                            str = "Container " + this.f1110a + " is not attached to window. ";
                        }
    ...
    public final void g() {
        ...
        while (it.hasNext()) {
            ...
            int i = 2;
            if (d0Var.f1090b == 2) {
                int visibility = d0Var.f1091c.I().getVisibility();
                if (visibility != 0) {
                    i = 4;
                    if (visibility != 4) {
                        if (visibility != 8) {
