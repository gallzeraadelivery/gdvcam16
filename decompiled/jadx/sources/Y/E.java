...
public final class E implements LayoutInflater.Factory2 {
    ...
    public final View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, X.a.f942a);
            ...
            if (attributeValue != null) {
                try {
                    z2 = AbstractComponentCallbacksC0051x.class.isAssignableFrom(K.b(context.getClassLoader(), attributeValue));
                ...
                if (z2) {
                    ...
                    AbstractComponentCallbacksC0051x B2 = resourceId != -1 ? s2.B(resourceId) : null;
                    ...
                    if (B2 == null) {
                        ...
                        B2.f1180n = true;
                        B2.f1189w = resourceId != 0 ? resourceId : id;
                        B2.f1190x = id;
                        B2.f1191y = string;
                        B2.f1181o = true;
                        B2.f1185s = s2;
                        B b2 = s2.f1009u;
                        B2.f1186t = b2;
                        B2.y(b2.f947f, attributeSet, B2.f1171b);
                        f2 = s2.a(B2);
                        if (S.H(2)) {
                        ...
                        B b3 = s2.f1009u;
                        B2.f1186t = b3;
                        B2.y(b3.f947f, attributeSet, B2.f1171b);
                        f2 = s2.f(B2);
                        if (S.H(2)) {
                    ...
                    if (B2.f1155F.getTag() == null) {
                        B2.f1155F.setTag(string);
                    }
                    B2.f1155F.addOnAttachStateChangeListener(new D(this, f2));
                    return B2.f1155F;
                }
            }
        }
