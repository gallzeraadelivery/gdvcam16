...
public final class M extends U.t {
    ...
    public A0.c G(AbstractActivityC0141i abstractActivityC0141i, Object obj) {
        switch (this.f970e) {
            case 1:
                ...
                q1.d.e(strArr, "input");
                if (strArr.length == 0) {
                    return new A0.c(19, j1.t.f2744a);
                }
                for (String str : strArr) {
                    if (Z0.i.j(abstractActivityC0141i, str) != 0) {
                        return null;
                    }
                }
            ...
            case 2:
                ...
                q1.d.e(str3, "input");
                if (Z0.i.j(abstractActivityC0141i, str3) != 0) {
                    return null;
                }
                return new A0.c(19, Boolean.TRUE);
            default:
                return super.G(abstractActivityC0141i, obj);
        }
    }
    ...
    public final Object S(int i, Intent intent) {
        switch (this.f970e) {
            case 0:
                return new C0097a(i, intent);
            case 1:
                j1.t tVar = j1.t.f2744a;
                if (i != -1 || intent == null) {
                    return tVar;
                }
    ...
    @Override // U.t
    public final Intent o(AbstractActivityC0141i abstractActivityC0141i, Object obj) {
        Bundle bundleExtra;
        switch (this.f970e) {
            case 0:
                C0104h c0104h = (C0104h) obj;
                Intent intent = new Intent("androidx.activity.result.contract.action.INTENT_SENDER_REQUEST");
                Intent intent2 = c0104h.f1726b;
                if (intent2 != null && (bundleExtra = intent2.getBundleExtra("androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE")) != null) {
                    intent.putExtra("androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE", bundleExtra);
                    intent2.removeExtra("androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE");
                    if (intent2.getBooleanExtra("androidx.fragment.extra.ACTIVITY_OPTIONS_BUNDLE", false)) {
                        c0104h = new C0104h(c0104h.f1725a, null, c0104h.f1727c, c0104h.d);
                    }
                }
                intent.putExtra("androidx.activity.result.contract.extra.INTENT_SENDER_REQUEST", c0104h);
                if (S.H(2)) {
