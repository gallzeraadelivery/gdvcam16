...
public class ButtonBarLayout extends LinearLayout {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int i5 = 0;
        if (this.f1395a) {
            if (size > this.f1397c && this.f1396b) {
                setStacked(false);
            }
            this.f1397c = size;
        }
        if (this.f1396b || View.MeasureSpec.getMode(i) != 1073741824) {
            i3 = i;
            z2 = false;
        } else {
        ...
        if (this.f1395a && !this.f1396b && (getMeasuredWidthAndState() & (-16777216)) == 16777216) {
            setStacked(true);
            z2 = true;
        }
        if (z2) {
