...
public class AlertDialogLayout extends AbstractC0259v0 {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0257u0).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) c0257u0).height;
                        ((LinearLayout.LayoutParams) c0257u0).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec, 0, i12, 0);
                        ((LinearLayout.LayoutParams) c0257u0).height = i14;
                    }
                }
                i13++;
