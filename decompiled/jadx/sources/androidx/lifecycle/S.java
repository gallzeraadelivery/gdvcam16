...
public final class S extends T0.e {
    ...
    public static S f1559e;

    /* renamed from: f, reason: collision with root package name */
    public static final T0.e f1560f = new T0.e(10);
    ...
    public final Q d(Class cls, Application application) {
        if (!AbstractC0073a.class.isAssignableFrom(cls)) {
            return U.t.p(cls);
        }
        try {
    ...
    public final Q r(Class cls, c0.e eVar) {
        ...
        Application application = (Application) eVar.f1729a.get(f1560f);
        if (application != null) {
            return d(cls, application);
        }
        if (AbstractC0073a.class.isAssignableFrom(cls)) {
