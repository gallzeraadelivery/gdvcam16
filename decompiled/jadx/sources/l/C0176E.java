...
public class C0176E implements InterfaceC0215Z {
    ...
    public final View f2950b;

    /* renamed from: c, reason: collision with root package name */
    public Object f2951c;

    public C0176E(AbsSeekBar absSeekBar) {
        this.f2949a = 0;
        this.f2950b = absSeekBar;
    }

    @Override // l.InterfaceC0215Z
    public void a(int i) {
    ...
    public KeyListener d(KeyListener keyListener) {
        ...
        ((C.j) ((A0.c) this.f2951c).f21b).getClass();
    ...
    public void e(AttributeSet attributeSet, int i) {
        switch (this.f2949a) {
            case 0:
                AbsSeekBar absSeekBar = (AbsSeekBar) this.f2950b;
                C0011l s2 = C0011l.s(absSeekBar.getContext(), attributeSet, d, i);
                Drawable i2 = s2.i(0);
                if (i2 != null) {
                ...
                return;
            default:
                TypedArray obtainStyledAttributes = ((EditText) this.f2950b).getContext().obtainStyledAttributes(attributeSet, AbstractC0112a.i, i, 0);
                try {
    ...
    public W.b f(InputConnection inputConnection, EditorInfo editorInfo) {
        A0.c cVar = (A0.c) this.f2951c;
        if (inputConnection == null) {
            cVar.getClass();
            inputConnection = null;
        } else {
            C.j jVar = (C.j) cVar.f21b;
            jVar.getClass();
            if (!(inputConnection instanceof W.b)) {
                inputConnection = new W.b((EditText) jVar.f48b, inputConnection, editorInfo);
            }
        }
    ...
    public void g(boolean z2) {
        W.i iVar = (W.i) ((C.j) ((A0.c) this.f2951c).f21b).f49c;
        if (iVar.f823c != z2) {
            if (iVar.f822b != null) {
                U.i a2 = U.i.a();
                W.h hVar = iVar.f822b;
                ...
                ReentrantReadWriteLock reentrantReadWriteLock = a2.f748a;
                reentrantReadWriteLock.writeLock().lock();
                try {
                    a2.f749b.remove(hVar);
                } finally {
    ...
    public C0176E(EditText editText) {
        this.f2949a = 1;
        this.f2950b = editText;
        this.f2951c = new A0.c(editText);
    }

    public C0176E(C0219b0 c0219b0) {
        this.f2949a = 2;
        this.f2951c = c0219b0;
        this.f2949a = 2;
        this.f2950b = c0219b0;
