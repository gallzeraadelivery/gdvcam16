...
public abstract class AbstractC0266z {

    /* renamed from: a, reason: collision with root package name */
    public static long f3170a;

    /* renamed from: b, reason: collision with root package name */
    public static Method f3171b;
    ...
    public static boolean n() {
        ...
        try {
            if (f3171b == null) {
                f3170a = Trace.class.getField("TRACE_TAG_APP").getLong(null);
                f3171b = Trace.class.getMethod("isTagEnabled", Long.TYPE);
            }
            return ((Boolean) f3171b.invoke(null, Long.valueOf(f3170a))).booleanValue();
        } catch (Exception e2) {
    ...
    public static u1.c w(int i, int i2) {
        if (i2 > Integer.MIN_VALUE) {
            return new u1.c(i, i2 - 1, 1);
        }
        u1.c cVar = u1.c.d;
        return u1.c.d;
    }

    public abstract boolean a(q.g gVar, C0307c c0307c);
