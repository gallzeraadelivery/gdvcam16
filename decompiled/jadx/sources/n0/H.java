...
public abstract class H {
    ...
    public C0011l f3234a;

    /* renamed from: b, reason: collision with root package name */
    public RecyclerView f3235b;

    /* renamed from: c, reason: collision with root package name */
    public final C.j f3236c;
    public final C.j d;

    /* renamed from: e, reason: collision with root package name */
    public C0293v f3237e;
    ...
    public static int A(View view) {
        Rect rect = ((I) view.getLayoutParams()).f3247b;
        return view.getMeasuredWidth() + rect.left + rect.right;
    }

    public static int H(View view) {
        return ((I) view.getLayoutParams()).f3246a.b();
    }

    public static G I(Context context, AttributeSet attributeSet, int i, int i2) {
        G g2 = new G();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC0271a.f3209a, i, i2);
        g2.f3231a = obtainStyledAttributes.getInt(0, 1);
        g2.f3232b = obtainStyledAttributes.getInt(10, 1);
        g2.f3233c = obtainStyledAttributes.getBoolean(9, false);
    ...
    */
    ...
    public final int B() {
        ...
        AbstractC0297z adapter = recyclerView != null ? recyclerView.getAdapter() : null;
        if (adapter != null) {
            return adapter.a();
        }
        return 0;
    ...
    public int J(N n2, T t2) {
        RecyclerView recyclerView = this.f3235b;
        if (recyclerView == null || recyclerView.f1666k == null || !e()) {
            return 1;
        }
        return this.f3235b.f1666k.a();
    }

    public final void K(View view, Rect rect) {
        Matrix matrix;
        Rect rect2 = ((I) view.getLayoutParams()).f3247b;
        rect.set(-rect2.left, -rect2.top, view.getWidth() + rect2.right, view.getHeight() + rect2.bottom);
        if (this.f3235b != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
            RectF rectF = this.f3235b.f1664j;
            rectF.set(rect);
    ...
    public void O(int i) {
        RecyclerView recyclerView = this.f3235b;
        if (recyclerView != null) {
            int f2 = recyclerView.f1656e.f();
            for (int i2 = 0; i2 < f2; i2++) {
                recyclerView.f1656e.e(i2).offsetLeftAndRight(i);
            }
        }
    }
    ...
    public void P(int i) {
        ...
        if (recyclerView != null) {
            int f2 = recyclerView.f1656e.f();
            for (int i2 = 0; i2 < f2; i2++) {
                recyclerView.f1656e.e(i2).offsetTopAndBottom(i);
            }
        }
    }
    ...
    public void T(AccessibilityEvent accessibilityEvent) {
        ...
        boolean z2 = true;
        if (!recyclerView.canScrollVertically(1) && !this.f3235b.canScrollVertically(-1) && !this.f3235b.canScrollHorizontally(-1) && !this.f3235b.canScrollHorizontally(1)) {
            z2 = false;
        }
        accessibilityEvent.setScrollable(z2);
        AbstractC0297z abstractC0297z = this.f3235b.f1666k;
        if (abstractC0297z != null) {
            accessibilityEvent.setItemCount(abstractC0297z.a());
        }
    }

    public final void U(View view, M.k kVar) {
        W I2 = RecyclerView.I(view);
        if (I2 == null || I2.h() || ((ArrayList) this.f3234a.d).contains(I2.f3285a)) {
            return;
        }
        RecyclerView recyclerView = this.f3235b;
        V(recyclerView.f1652b, recyclerView.f1654c0, view, kVar);
    }
    ...
    */
    ...
    public void h(int i, int i2, T t2, C0285m c0285m) {
    }

    public final void h0(N n2) {
        ArrayList arrayList;
        int size = n2.f3254a.size();
        int i = size - 1;
        while (true) {
            arrayList = n2.f3254a;
            if (i < 0) {
            ...
            View view = ((W) arrayList.get(i)).f3285a;
            W I2 = RecyclerView.I(view);
            if (!I2.o()) {
                I2.n(false);
                if (I2.j()) {
                    this.f3235b.removeDetachedView(view, false);
                }
                D d = this.f3235b.f1634H;
                if (d != null) {
                    d.d(I2);
                }
                I2.n(true);
        ...
        arrayList.clear();
        ArrayList arrayList2 = n2.f3255b;
        if (arrayList2 != null) {
            arrayList2.clear();
        }
        if (size > 0) {
            this.f3235b.invalidate();
        }
    }

    public void i(int i, C0285m c0285m) {
    }

    public final void i0(View view, N n2) {
        C0011l c0011l = this.f3234a;
        C0296y c0296y = (C0296y) c0011l.f349b;
        int indexOfChild = c0296y.f3460a.indexOfChild(view);
        if (indexOfChild >= 0) {
            if (((C0274b) c0011l.f350c).f(indexOfChild)) {
                c0011l.w(view);
            }
            c0296y.h(indexOfChild);
        }
        n2.f(view);
    }
    ...
    public final void j0(int i) {
        if (u(i) != null) {
            ...
            int k2 = c0011l.k(i);
            C0296y c0296y = (C0296y) c0011l.f349b;
            View childAt = c0296y.f3460a.getChildAt(k2);
            if (childAt == null) {
                return;
            }
            if (((C0274b) c0011l.f350c).f(k2)) {
                c0011l.w(childAt);
            }
            c0296y.h(k2);
        }
    ...
    */
    public boolean k0(androidx.recyclerview.widget.RecyclerView r9, android.view.View r10, android.graphics.Rect r11, boolean r12, boolean r13) {
        ...
        L7c:
            ...
            int r5 = r8.D()
            int r4 = r4 - r5
            androidx.recyclerview.widget.RecyclerView r5 = r8.f3235b
    ...
    public final void p(N n2) {
        for (int v2 = v() - 1; v2 >= 0; v2--) {
            ...
            if (!I2.o()) {
                if (!I2.f() || I2.h() || this.f3235b.f1666k.f3462b) {
                    u(v2);
                    this.f3234a.d(v2);
                    n2.h(u2);
                    this.f3235b.f1658f.J(I2);
                } else {
                    j0(v2);
                    n2.g(I2);
                }
    ...
    public View q(int i) {
        ...
        for (int i2 = 0; i2 < v2; i2++) {
            View u2 = u(i2);
            W I2 = RecyclerView.I(u2);
            if (I2 != null && I2.b() == i && !I2.o() && (this.f3235b.f1654c0.f3272g || !I2.h())) {
                return u2;
            }
        }
        return null;
    ...
    public final void q0(int i, int i2) {
        this.f3244n = View.MeasureSpec.getSize(i);
        int mode = View.MeasureSpec.getMode(i);
        this.f3242l = mode;
        if (mode == 0) {
            int[] iArr = RecyclerView.f1625s0;
        }
        this.f3245o = View.MeasureSpec.getSize(i2);
        int mode2 = View.MeasureSpec.getMode(i2);
        this.f3243m = mode2;
        if (mode2 == 0) {
            int[] iArr2 = RecyclerView.f1625s0;
        }
    }
    ...
    public void r0(Rect rect, int i, int i2) {
        ...
        RecyclerView recyclerView = this.f3235b;
        WeakHashMap weakHashMap = L.S.f299a;
        this.f3235b.setMeasuredDimension(g(i, F2, recyclerView.getMinimumWidth()), g(i2, D2, this.f3235b.getMinimumHeight()));
    }
    ...
    public final void s0(int i, int i2) {
        ...
        this.f3235b.h.set(i6, i4, i3, i5);
        r0(this.f3235b.h, i, i2);
    }
    ...
    public final void t0(RecyclerView recyclerView) {
        if (recyclerView == null) {
            ...
            this.f3235b = recyclerView;
            this.f3234a = recyclerView.f1656e;
            this.f3244n = recyclerView.getWidth();
            this.f3245o = recyclerView.getHeight();
        }
        this.f3242l = 1073741824;
        this.f3243m = 1073741824;
    }
    ...
    public int x(N n2, T t2) {
        RecyclerView recyclerView = this.f3235b;
        if (recyclerView == null || recyclerView.f1666k == null || !d()) {
            return 1;
        }
        return this.f3235b.f1666k.a();
    }
    ...
    public final void y0(C0293v c0293v) {
        C0293v c0293v2 = this.f3237e;
        if (c0293v2 != null && c0293v != c0293v2 && c0293v2.f3447e) {
            c0293v2.i();
        }
        this.f3237e = c0293v;
        RecyclerView recyclerView = this.f3235b;
        V v2 = recyclerView.f1649W;
        v2.f3283g.removeCallbacks(v2);
        v2.f3280c.abortAnimation();
        if (c0293v.h) {
            Log.w("RecyclerView", "An instance of " + c0293v.getClass().getSimpleName() + " was started more than once. Each instance of" + c0293v.getClass().getSimpleName() + " is intended to only be used once. You should create a new instance for each use.");
        }
        c0293v.f3445b = recyclerView;
        c0293v.f3446c = this;
        int i = c0293v.f3444a;
        if (i == -1) {
            throw new IllegalArgumentException("Invalid target position");
        }
        recyclerView.f1654c0.f3267a = i;
        c0293v.f3447e = true;
        c0293v.d = true;
        c0293v.f3448f = recyclerView.f1668l.q(i);
        c0293v.f3445b.f1649W.a();
        c0293v.h = true;
    }
