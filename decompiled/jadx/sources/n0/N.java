...
public final class N {
    ...
    public final ArrayList f3254a;

    /* renamed from: b, reason: collision with root package name */
    public ArrayList f3255b;

    /* renamed from: c, reason: collision with root package name */
    public final ArrayList f3256c;
    public final List d;
    ...
    public final void a(W w2, boolean z2) {
        ...
        Y y2 = recyclerView.f1665j0;
        if (y2 != null) {
            X x2 = y2.f3301e;
            View view = w2.f3285a;
            L.S.h(view, x2 != null ? (C0001b) x2.f3300e.remove(view) : null);
        }
        if (z2 && recyclerView.f1654c0 != null) {
            recyclerView.f1658f.K(w2);
        }
        w2.f3299r = null;
        M c2 = c();
        c2.getClass();
        int i = w2.f3289f;
        ArrayList arrayList = c2.a(i).f3249a;
        if (((L) c2.f3252a.get(i)).f3250b <= arrayList.size()) {
            return;
        }
        w2.m();
        arrayList.add(w2);
    ...
    public final int b(int i) {
        RecyclerView recyclerView = this.h;
        if (i >= 0 && i < recyclerView.f1654c0.b()) {
            return !recyclerView.f1654c0.f3272g ? i : recyclerView.d.e(i, 0);
        }
        throw new IndexOutOfBoundsException("invalid position " + i + ". State item count is " + recyclerView.f1654c0.b() + recyclerView.y());
    }

    public final M c() {
        if (this.f3259g == null) {
            M m2 = new M();
            m2.f3252a = new SparseArray();
            m2.f3253b = 0;
            this.f3259g = m2;
        }
        return this.f3259g;
    ...
    public final void d() {
        ...
        C0285m c0285m = this.h.b0;
        int[] iArr2 = c0285m.f3407c;
        if (iArr2 != null) {
            Arrays.fill(iArr2, -1);
        }
        c0285m.d = 0;
    ...
    public final void f(View view) {
        ...
        g(I2);
        if (recyclerView.f1634H == null || I2.g()) {
            return;
        }
        recyclerView.f1634H.d(I2);
    }
    ...
    */
    ...
    public final void h(View view) {
        D d;
        W I2 = RecyclerView.I(view);
        boolean z2 = (I2.f3291j & 12) != 0;
        RecyclerView recyclerView = this.h;
        if (!z2 && I2.k() && (d = recyclerView.f1634H) != null) {
            C0281i c0281i = (C0281i) d;
            if (I2.c().isEmpty() && c0281i.f3365g && !I2.f()) {
                if (this.f3255b == null) {
        ...
        if (I2.f() && !I2.h() && !recyclerView.f1666k.f3462b) {
    ...
    */
    ...
    public final void j(W w2) {
        if (w2.f3296o) {
            this.f3255b.remove(w2);
        } else {
            this.f3254a.remove(w2);
        }
        w2.f3295n = null;
        w2.f3296o = false;
        w2.f3291j &= -33;
    ...
    public final void k() {
        H h = this.h.f1668l;
        this.f3258f = this.f3257e + (h != null ? h.f3240j : 0);
        ArrayList arrayList = this.f3256c;
        for (int size = arrayList.size() - 1; size >= 0 && arrayList.size() > this.f3258f; size--) {
            e(size);
        }
    }
}
