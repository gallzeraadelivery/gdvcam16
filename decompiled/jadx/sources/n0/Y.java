...
public final class Y extends C0001b {
    ...
    public final void d(View view, M.k kVar) {
        ...
        if (recyclerView2.canScrollVertically(-1) || layoutManager.f3235b.canScrollHorizontally(-1)) {
            kVar.a(8192);
            accessibilityNodeInfo.setScrollable(true);
        }
        if (layoutManager.f3235b.canScrollVertically(1) || layoutManager.f3235b.canScrollHorizontally(1)) {
            kVar.a(4096);
            accessibilityNodeInfo.setScrollable(true);
        }
    ...
    */
    public final boolean g(android.view.View r3, int r4, android.os.Bundle r5) {
        ...
        L8:
            ...
            androidx.recyclerview.widget.RecyclerView r3 = r2.f3235b
            n0.N r1 = r3.f1652b
        ...
        L3f:
            r3 = r0
        L40:
            androidx.recyclerview.widget.RecyclerView r1 = r2.f3235b
        ...
        L6b:
            r3 = r0
        L6c:
            androidx.recyclerview.widget.RecyclerView r4 = r2.f3235b
        ...
        L80:
            ...
            goto L8b
        L85:
            androidx.recyclerview.widget.RecyclerView r2 = r2.f3235b
            r2.Z(r4, r3, r5)
            return r5
        L8b:
            return r0
