...
public final class r implements L.r, InterfaceC0231h0, k.x {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f2542a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ B f2543b;
    ...
    public boolean g(k.m mVar) {
        ...
        switch (this.f2542a) {
            case 2:
                Window.Callback callback2 = this.f2543b.f2429l.getCallback();
                if (callback2 != null) {
            ...
            default:
                if (mVar == mVar.k()) {
                    B b2 = this.f2543b;
                    if (b2.f2401F && (callback = b2.f2429l.getCallback()) != null && !b2.f2411Q) {
    ...
    public u0 v(View view, u0 u0Var) {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) b2.f2439v.getLayoutParams();
            if (b2.f2439v.isShown()) {
                if (b2.f2422c0 == null) {
                    b2.f2422c0 = new Rect();
                    b2.f2423d0 = new Rect();
                }
                Rect rect = b2.f2422c0;
                Rect rect2 = b2.f2423d0;
                rect.set(u0Var2.b(), u0Var2.d(), u0Var2.c(), u0Var2.a());
                f1.a(b2.f2396A, rect, rect2);
                int i = rect.top;
                int i2 = rect.left;
                int i3 = rect.right;
                ...
                if (i <= 0 || b2.f2398C != null) {
                    View view2 = b2.f2398C;
                    if (view2 != null) {
                        ...
                        if (i4 != i5 || marginLayoutParams2.leftMargin != b3 || marginLayoutParams2.rightMargin != c2) {
                            ...
                            b2.f2398C.setLayoutParams(marginLayoutParams2);
                        }
                    }
                } else {
                    ...
                    b2.f2396A.addView(b2.f2398C, -1, layoutParams);
                }
                View view4 = b2.f2398C;
                r9 = view4 != null;
                if (r9 && view4.getVisibility() != 0) {
                    View view5 = b2.f2398C;
            ...
            if (r9) {
                b2.f2439v.setLayoutParams(marginLayoutParams);
            }
        }
        View view6 = b2.f2398C;
        if (view6 != null) {
