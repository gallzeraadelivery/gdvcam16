...
public abstract class u {
    ...
    public static void c(H.g gVar) {
        LocaleList.setDefault(LocaleList.forLanguageTags(gVar.f177a.f178a.toLanguageTags()));
    }

    public static void d(Configuration configuration, H.g gVar) {
        configuration.setLocales(LocaleList.forLanguageTags(gVar.f177a.f178a.toLanguageTags()));
    }
}
