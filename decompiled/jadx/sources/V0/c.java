...
public abstract class c extends FrameLayout {
    ...
    public c(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, AbstractC0368a.f4133B);
        if (obtainStyledAttributes.hasValue(6)) {
            float dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(6, 0);
            WeakHashMap weakHashMap = S.f299a;
            G.s(this, dimensionPixelSize);
        }
        this.f798b = obtainStyledAttributes.getInt(2, 0);
        if (obtainStyledAttributes.hasValue(8) || obtainStyledAttributes.hasValue(9)) {
            this.f797a = k.b(context2, attributeSet, 0, 0).a();
        }
        this.f799c = obtainStyledAttributes.getFloat(3, 1.0f);
        ...
        this.f800e = obtainStyledAttributes.getDimensionPixelSize(0, -1);
        this.f801f = obtainStyledAttributes.getDimensionPixelSize(7, -1);
        ...
        if (getBackground() == null) {
            ...
            ColorStateList colorStateList = this.f802g;
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable != null && this.f802g != null) {
            drawable = drawable.mutate();
            E.a.h(drawable, this.f802g);
