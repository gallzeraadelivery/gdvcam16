...
public final class f {
    ...
    public static final f f397g;
    public static final f h;
    public static final f i;

    /* renamed from: j, reason: collision with root package name */
    public static final f f398j;

    /* renamed from: k, reason: collision with root package name */
    public static final f f399k;

    /* renamed from: l, reason: collision with root package name */
    public static final f f400l;
    ...
    static {
        ...
        f399k = new f(AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_UP, R.id.accessibilityActionScrollUp, null, null, null);
        new f(AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_LEFT, R.id.accessibilityActionScrollLeft, null, null, null);
        f400l = new f(AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN, R.id.accessibilityActionScrollDown, null, null, null);
        ...
        new f(accessibilityAction2, R.id.accessibilityActionDragDrop, null, null, null);
        if (i2 >= 32) {
        ...
        new f(accessibilityAction3, R.id.accessibilityActionDragCancel, null, null, null);
        if (i2 >= 33) {
        ...
        new f(accessibilityAction4, R.id.accessibilityActionShowTextSuggestions, null, null, null);
    ...
    public final int a() {
        return ((AccessibilityNodeInfo.AccessibilityAction) this.f401a).getId();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        Object obj2 = ((f) obj).f401a;
        Object obj3 = this.f401a;
    ...
    public f(Object obj, int i2, String str, t tVar, Class cls) {
        ...
        this.d = tVar;
        if (obj == null) {
            this.f401a = new AccessibilityNodeInfo.AccessibilityAction(i2, str);
        } else {
            this.f401a = obj;
        }
        this.f403c = cls;
