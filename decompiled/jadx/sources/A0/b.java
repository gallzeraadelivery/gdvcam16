...
public final class b extends i {
    ...
    public final void V(View view, int i) {
        this.f18g = i;
        this.f17f = view.getLeft();
        ViewParent parent = view.getParent();
        if (parent != null) {
            SwipeDismissBehavior swipeDismissBehavior = this.h;
            swipeDismissBehavior.f1764c = true;
            parent.requestDisallowInterceptTouchEvent(true);
            swipeDismissBehavior.f1764c = false;
        }
    }
    ...
    public final void X(View view, int i, int i2) {
        ...
        SwipeDismissBehavior swipeDismissBehavior = this.h;
        float f2 = width * swipeDismissBehavior.f1765e;
        float width2 = view.getWidth() * swipeDismissBehavior.f1766f;
        float abs = Math.abs(i - this.f17f);
        if (abs <= f2) {
            view.setAlpha(1.0f);
        } else if (abs >= width2) {
            view.setAlpha(0.0f);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0050, code lost:
        ...
        if (java.lang.Math.abs(r9.getLeft() - r8.f17f) >= java.lang.Math.round(r9.getWidth() * 0.5f)) goto L27;
     */
    @Override // Z0.i
    /*
    ...
    */
    public final void Y(android.view.View r9, float r10, float r11) {
        /*
            ...
            r4 = 0
            if (r1 == 0) goto L39
            java.util.WeakHashMap r5 = L.S.f299a
        ...
        L69:
            ...
            A0.d r8 = new A0.d
            r8.<init>(r2, r9, r3)
            java.util.WeakHashMap r10 = L.S.f299a
    ...
    public final int m(View view, int i) {
        ...
        if (i2 == 0) {
            ...
            width = this.f17f - view.getWidth();
            width2 = this.f17f + view.getWidth();
        } else if (z2) {
            width = this.f17f;
            width3 = view.getWidth();
            width2 = width3 + width;
