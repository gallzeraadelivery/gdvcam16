...
public final class z {
    ...
    public static final ThreadLocal f2358c = new ThreadLocal();
    ...
    public static C0127h c(TypedArray typedArray, Resources resources, int i) {
        boolean z2;
        H h;
        H h2;
        H h3;
        ...
        ThreadLocal threadLocal = f2358c;
        ...
        C0124e c0124e = H.f2262c;
        H h6 = H.f2266j;
        C0123d c0123d = H.f2272p;
        H h7 = H.f2269m;
        H h8 = H.f2265g;
        H h9 = H.d;
        H h10 = H.f2264f;
        ...
        if (string != null) {
            ...
            if ("integer".equals(string)) {
                ...
                z2 = z6;
                h3 = "integer[]".equals(string) ? h : "List<Int>".equals(string) ? H.f2263e : "long".equals(string) ? h10 : "long[]".equals(string) ? h8 : "List<Long>".equals(string) ? H.h : "boolean".equals(string) ? h11 : "boolean[]".equals(string) ? h7 : "List<Boolean>".equals(string) ? H.f2270n : "string".equals(string) ? h12 : "string[]".equals(string) ? c0123d : "List<String>".equals(string) ? H.f2273q : "float".equals(string) ? h13 : "float[]".equals(string) ? h6 : "List<Float>".equals(string) ? H.f2267k : null;
            }
            if (h3 == null) {
                if ("reference".equals(string)) {
                    ...
                    try {
                        ...
                        H c0116d = Parcelable.class.isAssignableFrom(cls2) ? z5 ? new C0116D(cls2) : new C0117E(cls2) : (!Enum.class.isAssignableFrom(cls2) || z5) ? Serializable.class.isAssignableFrom(cls2) ? z5 ? new C0118F(cls2) : new C0119G(cls2) : null : new C0115C(cls2);
                        if (c0116d == null) {
            ...
            if (h15 != null) {
                ...
                if (obj.getClass().isArray()) {
                    ...
                    if (cls.isAssignableFrom(componentType3)) {
                        ...
                        h5 = new C0118F(componentType4);
                    }
                }
                if (obj instanceof Parcelable) {
                    h5 = new C0117E(obj.getClass());
                } else if (obj instanceof Enum) {
                    h5 = new C0115C(obj.getClass());
                } else {
                    if (!(obj instanceof Serializable)) {
                        throw new IllegalArgumentException("Object of type " + obj.getClass().getName() + " is not supported for navigation arguments.");
                    }
                    h5 = new C0119G(obj.getClass());
                }
            }
            h3 = h5;
        }
        return new C0127h(h3, z2, obj, z3);
    }
