...
public final class C0123d extends H {

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ int f2285r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ C0123d(int i, boolean z2) {
        super(z2);
        this.f2285r = i;
    }
    ...
    public static int[] h(String str) {
        q1.d.e(str, "value");
        return new int[]{((Number) H.f2261b.d(str)).intValue()};
    }

    public static long[] i(String str) {
        q1.d.e(str, "value");
        return new long[]{((Number) H.f2264f.d(str)).longValue()};
    }

    public static boolean[] j(String str) {
        q1.d.e(str, "value");
        return new boolean[]{((Boolean) H.f2268l.d(str)).booleanValue()};
    }
    ...
    public final Object a(Bundle bundle, String str) {
        ...
        switch (this.f2285r) {
            case 0:
                ...
                if (!bundle.containsKey(str) || AbstractC0266z.o(bundle, str)) {
                    return null;
                }
    ...
    public final Object c(Object obj, String str) {
        switch (this.f2285r) {
            ...
            case 1:
                List list = (List) obj;
                C0124e c0124e = H.f2268l;
                return list != null ? j1.j.u0(list, U.t.M(c0124e.d(str))) : U.t.M(c0124e.d(str));
            case 2:
            ...
            case 3:
                List list2 = (List) obj;
                C0124e c0124e2 = H.i;
                return list2 != null ? j1.j.u0(list2, U.t.M(c0124e2.d(str))) : U.t.M(c0124e2.d(str));
            case 4:
                int[] iArr = (int[]) obj;
                if (iArr == null) {
                    return h(str);
            ...
            case 5:
                List list3 = (List) obj;
                C0124e c0124e3 = H.f2261b;
                return list3 != null ? j1.j.u0(list3, U.t.M(c0124e3.d(str))) : U.t.M(c0124e3.d(str));
            case 6:
                long[] jArr = (long[]) obj;
                if (jArr == null) {
                    return i(str);
            ...
            case 7:
                List list4 = (List) obj;
                C0124e c0124e4 = H.f2264f;
                return list4 != null ? j1.j.u0(list4, U.t.M(c0124e4.d(str))) : U.t.M(c0124e4.d(str));
            case 8:
    ...
    public final Object d(String str) {
        switch (this.f2285r) {
            ...
            case 5:
                q1.d.e(str, "value");
                return U.t.M(H.f2261b.d(str));
            case 6:
                return i(str);
            case 7:
                q1.d.e(str, "value");
                return U.t.M(H.f2264f.d(str));
            case 8:
                q1.d.e(str, "value");
                return new String[]{str};
            default:
