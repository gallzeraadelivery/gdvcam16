...
public final class L {
    ...
    public static final LinkedHashMap f2277b = new LinkedHashMap();

    /* renamed from: a, reason: collision with root package name */
    public final LinkedHashMap f2278a = new LinkedHashMap();
    ...
    public final void a(K k2) {
        ...
        LinkedHashMap linkedHashMap = this.f2278a;
        K k3 = (K) linkedHashMap.get(B2);
        if (q1.d.a(k3, k2)) {
            return;
        }
        boolean z2 = false;
        if (k3 != null && k3.f2276b) {
            z2 = true;
        }
        if (z2) {
