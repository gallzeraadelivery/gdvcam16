...
public final class g {
    ...
    public final boolean f8j;

    /* renamed from: k, reason: collision with root package name */
    public final Notification f9k;

    /* renamed from: l, reason: collision with root package name */
    public final ArrayList f10l;

    /* renamed from: b, reason: collision with root package name */
    public final ArrayList f3b = new ArrayList();

    /* renamed from: c, reason: collision with root package name */
    public final ArrayList f4c = new ArrayList();
    public final ArrayList d = new ArrayList();

    /* renamed from: g, reason: collision with root package name */
    public final boolean f7g = true;

    public g(Service service, String str) {
        Notification notification = new Notification();
        this.f9k = notification;
        this.f2a = service;
        this.i = str;
    ...
    public final Notification a() {
        ...
        Notification notification = this.f9k;
        a2.setWhen(notification.when).setSmallIcon(notification.icon, notification.iconLevel).setContent(notification.contentView).setTicker(notification.tickerText, null).setVibrate(notification.vibrate).setLights(notification.ledARGB, notification.ledOnMS, notification.ledOffMS).setOngoing((notification.flags & 2) != 0).setOnlyAlertOnce((notification.flags & 8) != 0).setAutoCancel((notification.flags & 16) != 0).setDefaults(notification.defaults).setContentTitle(this.f5e).setContentText(this.f6f).setContentInfo(null).setContentIntent(null).setDeleteIntent(notification.deleteIntent).setFullScreenIntent(null, (notification.flags & 128) != 0).setNumber(0).setProgress(0, 0, false);
        j.b(a2, null);
        ...
        Iterator it3 = this.f4c.iterator();
        if (it3.hasNext()) {
            it3.next().getClass();
            throw new ClassCastException();
        }
