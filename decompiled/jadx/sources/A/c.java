...
public abstract class c {
    ...
    public static Intent b(AbstractActivityC0141i abstractActivityC0141i) {
        Intent parentActivityIntent = abstractActivityC0141i.getParentActivityIntent();
        if (parentActivityIntent != null) {
            return parentActivityIntent;
        }
        try {
            String c2 = c(abstractActivityC0141i, abstractActivityC0141i.getComponentName());
            if (c2 == null) {
                return null;
            }
            ComponentName componentName = new ComponentName(abstractActivityC0141i, c2);
            try {
                return c(abstractActivityC0141i, componentName) == null ? Intent.makeMainActivity(componentName) : new Intent().setComponent(componentName);
