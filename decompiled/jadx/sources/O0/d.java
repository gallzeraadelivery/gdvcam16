...
public final class d extends k.m {
    ...
    public final o a(int i, int i2, int i3, CharSequence charSequence) {
        ...
        String simpleName = this.f525z.getSimpleName();
    ...
    public final SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        throw new UnsupportedOperationException(this.f525z.getSimpleName().concat(" does not support submenus"));
    }
}
