...
public final class i implements k.k {
    ...
    public boolean q(k.m mVar, MenuItem menuItem) {
        ...
        int i5;
        boolean z2;
        k kVar = this.f562a.f567e;
        if (kVar == null) {
            return false;
        }
        q1.d.e(menuItem, "item");
        y yVar = (y) ((Q.b) kVar).f571a;
        i0.j jVar = yVar.f2353b;
        v f2 = jVar.f();
        q1.d.b(f2);
        w wVar = f2.f2348c;
        q1.d.b(wVar);
        if (wVar.g(menuItem.getItemId()) instanceof C0121b) {
        ...
        try {
            yVar.a(menuItem.getItemId(), new C0113A(true, true, i5, false, z2, i6, i7, i8, i9));
            v f3 = jVar.f();
            if (f3 != null) {
            ...
            int i11 = v.f2345f;
            StringBuilder e3 = D.f.e("Ignoring onNavDestinationSelected for MenuItem ", t.t(new U.m(yVar.f2352a, 1), menuItem.getItemId()), " as it cannot be found from the current destination ");
            e3.append(jVar.f());
