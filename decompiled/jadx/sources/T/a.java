...
public final class a extends A0.c {
    ...
    public final boolean A(int i, int i2, Bundle bundle) {
        ...
        if (i2 == 64) {
            ...
            if (!accessibilityManager.isEnabled() || !accessibilityManager.isTouchExplorationEnabled() || (i3 = bVar.f625k) == i) {
                return false;
            }
            if (i3 != Integer.MIN_VALUE) {
                bVar.f625k = Integer.MIN_VALUE;
                bVar.i.invalidate();
                bVar.q(i3, 65536);
            }
            bVar.f625k = i;
    ...
    public final k x(int i) {
        return new k(AccessibilityNodeInfo.obtain(this.d.n(i).f405a));
    }

    @Override // A0.c
    public final k y(int i) {
        b bVar = this.d;
        int i2 = i == 2 ? bVar.f625k : bVar.f626l;
