...
public abstract class i implements Z {
    ...
    public static App f1230a;

    /* renamed from: b, reason: collision with root package name */
    public static a1.b f1231b;

    /* renamed from: c, reason: collision with root package name */
    public static T0.e f1232c;
    public static f d;

    /* renamed from: e, reason: collision with root package name */
    public static Boolean f1233e;
    ...
    */
    ...
    public static final Bundle f(i1.d... dVarArr) {
        ...
        for (i1.d dVar : dVarArr) {
            String str = (String) dVar.f2658a;
            Object obj = dVar.f2659b;
            if (obj == null) {
    ...
    public static int j(Context context, String str) {
        if (str != null) {
            return (Build.VERSION.SDK_INT >= 33 || !TextUtils.equals("android.permission.POST_NOTIFICATIONS", str)) ? context.checkPermission(str, Process.myPid(), Process.myUid()) : n.a(new o(context).f11a) ? 0 : -1;
        }
    ...
    public static void k0(String str) {
        ...
        gVar.f1225e.getClass();
        String str2 = gVar.f1222a;
        if (f1233e == null) {
            App app = f1230a;
            if (app == null) {
                throw new IllegalStateException("Toaster has not been initialized");
            }
            f1233e = Boolean.valueOf((app.getApplicationInfo().flags & 2) != 0);
        }
        if (f1233e.booleanValue()) {
        ...
        if (gVar.f1223b == -1) {
            a1.b bVar = gVar.d;
            String str3 = gVar.f1222a;
            ((h) bVar).getClass();
            gVar.f1223b = str3.length() <= 20 ? 0 : 1;
        }
        h hVar = (h) gVar.d;
        hVar.getClass();
        long uptimeMillis = SystemClock.uptimeMillis();
        Handler handler = h.f1226e;
        handler.postAtTime(new D0.i(7, hVar), hVar.d, uptimeMillis);
        handler.postAtTime(new A0.d(hVar, gVar, 3, false), hVar.f1229c, SystemClock.uptimeMillis() + 300);
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x0047, code lost:
        ...
        if (r5.f52c == r8.hashCode()) goto L21;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static android.content.res.ColorStateList v(android.content.Context r8, int r9) {
        /*
            ...
            C.n r1 = new C.n
            r1.<init>(r0, r8)
            java.lang.Object r2 = C.r.f63c
            monitor-enter(r2)
            java.util.WeakHashMap r3 = C.r.f62b     // Catch: java.lang.Throwable -> L3c
            ...
            if (r5 == 0) goto L50
            android.content.res.Configuration r6 = r5.f51b     // Catch: java.lang.Throwable -> L3c
            android.content.res.Configuration r7 = r0.getConfiguration()     // Catch: java.lang.Throwable -> L3c
            boolean r6 = r6.equals(r7)     // Catch: java.lang.Throwable -> L3c
            if (r6 == 0) goto L4d
            if (r8 != 0) goto L3f
            int r6 = r5.f52c     // Catch: java.lang.Throwable -> L3c
            if (r6 == 0) goto L49
            goto L3f
        L3c:
            r8 = move-exception
        ...
        L3f:
            ...
            if (r6 != r7) goto L4d
        L49:
            android.content.res.ColorStateList r3 = r5.f50a     // Catch: java.lang.Throwable -> L3c
        ...
        L52:
            ...
            return r3
        L55:
            java.lang.ThreadLocal r2 = C.r.f61a
        ...
        L87:
            ...
            java.lang.Object r2 = C.r.f63c
            monitor-enter(r2)
            java.util.WeakHashMap r0 = C.r.f62b     // Catch: java.lang.Throwable -> L9f
        ...
        La1:
            ...
            android.content.res.Resources r1 = r1.f53a     // Catch: java.lang.Throwable -> L9f
    ...
    public static ColorStateList w(Context context, C0011l c0011l, int i) {
        ...
        return (!typedArray.hasValue(i) || (resourceId = typedArray.getResourceId(i, 0)) == 0 || (v2 = v(context, resourceId)) == null) ? c0011l.g(i) : v2;
    }
