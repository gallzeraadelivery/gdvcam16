...
public class f implements p, InterfaceC0106b, x, l0.e {
    public f(View view) {
    }

    public static f d(Context context, int i) {
        i.g("Cannot create a CalendarItemStyle with a styleResId of 0", i != 0);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, AbstractC0368a.f4149o);
    ...
    public u0 a(View view, u0 u0Var, q qVar) {
        ...
        int i3 = i2 + b2;
        qVar.f490c = i3;
        view.setPaddingRelative(i, qVar.f489b, i3, qVar.d);
        return u0Var;
    }
