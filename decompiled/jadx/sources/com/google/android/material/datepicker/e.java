...
public final class e extends BaseAdapter {
    ...
    public e() {
        ...
        this.f1874a = c2;
        this.f1875b = c2.getMaximum(7);
        this.f1876c = c2.getFirstDayOfWeek();
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        ...
        int i2 = i + this.f1876c;
        int i3 = this.f1875b;
        if (i2 > i3) {
            i2 -= i3;
        }
        Calendar calendar = this.f1874a;
        calendar.set(7, i2);
