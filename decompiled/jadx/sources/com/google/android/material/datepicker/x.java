...
public final class x extends AbstractC0297z {
    ...
    public final int a() {
        return this.f1941c.f1887Y.f1869f;
    }

    @Override // n0.AbstractC0297z
    public final void c(W w2, int i) {
        j jVar = this.f1941c;
        int i2 = jVar.f1887Y.f1865a.f1924c + i;
        String format = String.format(Locale.getDefault(), "%d", Integer.valueOf(i2));
        TextView textView = ((w) w2).f1940t;
        ...
        c cVar = jVar.b0;
        if (v.b().get(1) == i2) {
            Z0.f fVar = cVar.f1872b;
        } else {
            Z0.f fVar2 = cVar.f1871a;
        }
        throw null;
    }
