...
public class AppBarLayout$BaseBehavior<T> extends AbstractC0378a {
    ...
    public final boolean f(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        if (this.f1747e < 0) {
            this.f1747e = ViewConfiguration.get(coordinatorLayout.getContext()).getScaledTouchSlop();
        }
        if (motionEvent.getActionMasked() == 2 && this.f1745b) {
            int i = this.f1746c;
            if (i != -1 && (findPointerIndex = motionEvent.findPointerIndex(i)) != -1) {
                int y2 = (int) motionEvent.getY(findPointerIndex);
                if (Math.abs(y2 - this.d) > this.f1747e) {
                    this.d = y2;
                    return true;
                }
            }
        ...
        if (motionEvent.getActionMasked() != 0) {
            VelocityTracker velocityTracker = this.f1748f;
    ...
    @Override // y0.AbstractC0378a, y.AbstractC0371a
    ...
    */
    public final boolean q(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L36:
            ...
            throw r5
        L46:
            android.view.VelocityTracker r0 = r5.f1748f
            if (r0 != 0) goto L65
        L4a:
            r5.f1745b = r3
            r5.f1746c = r1
            android.view.VelocityTracker r6 = r5.f1748f
            if (r6 == 0) goto L58
            r6.recycle()
            r6 = 0
            r5.f1748f = r6
        ...
        L65:
            r0.addMovement(r7)
            android.view.VelocityTracker r7 = r5.f1748f
