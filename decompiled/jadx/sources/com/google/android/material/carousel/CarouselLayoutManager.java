...
public class CarouselLayoutManager extends H implements S {
    ...
    public final g f1840p;

    /* renamed from: q, reason: collision with root package name */
    public e f1841q;

    /* renamed from: r, reason: collision with root package name */
    public final View.OnLayoutChangeListener f1842r;

    public CarouselLayoutManager() {
        g gVar = new g();
        new d();
        this.f1842r = new View.OnLayoutChangeListener() { // from class: F0.a
    ...
    public final void Q(RecyclerView recyclerView) {
        ...
        gVar.f145b = f3;
        l0();
        recyclerView.addOnLayoutChangeListener(this.f1842r);
    }

    @Override // n0.H
    public final void R(RecyclerView recyclerView) {
        recyclerView.removeOnLayoutChangeListener(this.f1842r);
    }
    ...
    */
    ...
    public final void b0(N n2, T t2) {
        if (t2.b() > 0) {
            if ((A0() ? this.f3244n : this.f3245o) > 0.0f) {
                B0();
                View view = n2.i(0, Long.MAX_VALUE).f3285a;
    ...
    public CarouselLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC0368a.d);
