...
public class TextInputEditText extends C0262x {

    /* renamed from: f, reason: collision with root package name */
    public final Rect f1980f;
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        ...
        this.f1980f = new Rect();
        int[] iArr = AbstractC0368a.f4135D;
    ...
    public final void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f1981g || rect == null) {
            return;
        }
    ...
    public final boolean getGlobalVisibleRect(Rect rect, Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f1981g) {
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f1989E) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f1989E && super.getHint() == null) {
    ...
    @Override // l.C0262x, android.widget.TextView, android.view.View
