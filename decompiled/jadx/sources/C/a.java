...
public final class a {
    ...
    public static a a(int i) {
        ...
        float f19 = f16 * sVar.f66b;
        float f20 = sVar.f65a;
        float f21 = sVar.d;
        float pow4 = ((float) Math.pow(f19 / f20, sVar.f71j * f21)) * 100.0f;
        Math.sqrt(pow4 / 100.0f);
        float f22 = f20 + 4.0f;
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, sVar.f69f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos((((((double) f17) < 20.14d ? f17 + 360.0f : f17) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * sVar.f68e) * sVar.f67c) * ((float) Math.sqrt((f13 * f13) + (f12 * f12)))) / (f15 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow4 / 100.0d));
    ...
    public final int c(s sVar) {
        ...
        if (d != 0.0d) {
            ...
            if (d2 != 0.0d) {
                ...
                float pow = (float) Math.pow(f2 / Math.pow(1.64d - Math.pow(0.29d, sVar.f69f), 0.73d), 1.1111111111111112d);
                double d3 = (this.f27a * 3.1415927f) / 180.0f;
                float cos = ((float) (Math.cos(2.0d + d3) + 3.8d)) * 0.25f;
                float pow2 = sVar.f65a * ((float) Math.pow(f4 / 100.0d, (1.0d / sVar.d) / sVar.f71j));
                float f5 = cos * 3846.1538f * sVar.f68e * sVar.f67c;
                float f6 = pow2 / sVar.f66b;
        ...
        f2 = 0.0f;
        float pow4 = (float) Math.pow(f2 / Math.pow(1.64d - Math.pow(0.29d, sVar.f69f), 0.73d), 1.1111111111111112d);
        double d32 = (this.f27a * 3.1415927f) / 180.0f;
        float cos3 = ((float) (Math.cos(2.0d + d32) + 3.8d)) * 0.25f;
        float pow22 = sVar.f65a * ((float) Math.pow(f4 / 100.0d, (1.0d / sVar.d) / sVar.f71j));
        float f52 = cos3 * 3846.1538f * sVar.f68e * sVar.f67c;
        float f62 = pow22 / sVar.f66b;
