...
public abstract class h {
    ...
    public static final T0.e f86a = new T0.e();

    /* renamed from: b, reason: collision with root package name */
    public static final e0 f87b = new e0(16);
    ...
    public static Typeface a(Context context, i[] iVarArr, int i) {
        ...
        try {
            ...
            while (i2 < length) {
                i iVar = iVarArr[i2];
                try {
                    openFileDescriptor = contentResolver.openFileDescriptor(iVar.f261a, "r", null);
                ...
                if (openFileDescriptor == null) {
                    ...
                    try {
                        Font build = new Font.Builder(openFileDescriptor).setWeight(iVar.f263c).setSlant(iVar.d ? 1 : 0).setTtcIndex(iVar.f262b).build();
                        if (builder == null) {
    ...
    */
    ...
    public static Typeface c(Resources resources, int i, String str, int i2, int i3) {
        ...
        if (typeface != null) {
            f87b.j(d(resources, i, str, i2, i3), typeface);
        }
        return typeface;
    }
